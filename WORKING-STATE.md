...
### 1. GROUND FLOOR — Platform Infrastructure (P1)
- Three-layer platform project launched 6 April: Memory Infrastructure + Agent Team Blueprint + Lifecycle Archetypes
- Memory infrastructure is the immediate pain — GitHub sync reliability, fallback URL coverage, cross-surface consistency
- Systemic gap identified: mobile sessions write to Open Brain but never reconcile back to WORKING-STATE.md — caused 8-day drift this cycle
- Next: define agent personas (Audit, Architecture, Build, QA), run audit phase first
- Supersedes the original NemoClaw Sprint framing

### 2. Kamen M&G Due Diligence
- In-person visit **rescheduled to 23 April** (was 9 April)
- Pre-visit DD still required: strategic fit assessment, information request letter, CIPC/SARS checks, share vs asset purchase analysis
- Go/No-Go gates unchanged: channel conflict, operator availability, 18-month payback test
...
- Folder-to-project mapping captured in Open Brain as reference
- Old folder names retired: OpsManRevamp, HR_Compliance_Revamp, Scripts, KamenDueDiligence, DeliveryRouter, SpecilinkReports, Web-Experiments, ALTACeramicaWarranty, BMWTileSourcing
...
## Recent Decisions (since 2026-03-30)
...
| 7 Apr | Finserv/Mahlangu matter fully closed — R38k ex VAT paid, settled | Personal |
| 7 Apr | Clockwise removed from all skills — replacement calendar MCP needed | Personal |
| 6 Apr | GROUND FLOOR scoped as three-layer platform project (memory + agent blueprint + lifecycle) | Personal |
| 3 Apr | Agent memory & observability: tool-agnostic watch posture, Mem0 as default when needed | Personal |
...
## Initiative Tracker (Updated 7 April)
...
| AI Competence Programme | Institutional Capacity | Active (weekly cadence) | Next: receive HR data → org chart + AI tool decision |
| Product mix competitive study | Market Intelligence | Active | Deliverable in progress |
| Kamen M&G acquisition | Acquisitions | Active | DD before 23 April visit |
| JD Reviews (18 roles) | HR Track | Near complete | Status to confirm |
